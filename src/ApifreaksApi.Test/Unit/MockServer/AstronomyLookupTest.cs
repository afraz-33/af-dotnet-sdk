...
public class AstronomyLookupTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v1.0/geolocation/astronomy")
        ...
        var response = await Client.AstronomyLookupAsync(
            new AstronomyLookupRequest { ApiKey = "apiKey" }
        );
