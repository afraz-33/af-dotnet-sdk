...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::ApifreaksApi.Core.ApiResponse> SendRequestAsync(
        global::ApifreaksApi.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::ApifreaksApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::ApifreaksApi.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::ApifreaksApi.Core.BaseRequest request)
    {
