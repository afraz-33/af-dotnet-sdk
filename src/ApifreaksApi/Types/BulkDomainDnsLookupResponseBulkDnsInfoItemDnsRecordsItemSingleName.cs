...
[Serializable]
public record BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemSingleName
    : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemSingleNameDnsType DnsType { get; set; }
