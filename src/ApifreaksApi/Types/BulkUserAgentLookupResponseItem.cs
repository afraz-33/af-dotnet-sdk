...
[Serializable]
public record BulkUserAgentLookupResponseItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required BulkUserAgentLookupResponseItemDevice Device { get; set; }

    [JsonPropertyName("engine")]
    public required BulkUserAgentLookupResponseItemEngine Engine { get; set; }

    [JsonPropertyName("operating_system")]
    public required BulkUserAgentLookupResponseItemOperatingSystem OperatingSystem { get; set; }
