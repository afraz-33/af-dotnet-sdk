...
[Serializable]
public record DomainDnsLookupResponseDnsRecordsItemAdmin : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required DomainDnsLookupResponseDnsRecordsItemAdminDnsType DnsType { get; set; }
