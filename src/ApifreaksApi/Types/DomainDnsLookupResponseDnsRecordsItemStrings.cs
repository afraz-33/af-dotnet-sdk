...
[Serializable]
public record DomainDnsLookupResponseDnsRecordsItemStrings : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required DomainDnsLookupResponseDnsRecordsItemStringsDnsType DnsType { get; set; }
