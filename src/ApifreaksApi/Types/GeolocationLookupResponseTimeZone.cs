...
[Serializable]
public record GeolocationLookupResponseTimeZone : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public GeolocationLookupResponseTimeZoneDstStart? DstStart { get; set; }

    [JsonPropertyName("dst_end")]
    public GeolocationLookupResponseTimeZoneDstEnd? DstEnd { get; set; }
