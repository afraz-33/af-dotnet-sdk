...
[Serializable]
public record PhoneValidateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public PhoneValidateResponseRawInput? RawInput { get; set; }
    ...
    public PhoneValidateResponseLineType? LineType { get; set; }

    /// <summary>
    /// The number represented in four standardized formats. Only returned for valid numbers.
    /// </summary>
    [JsonPropertyName("formats")]
    public PhoneValidateResponseFormats? Formats { get; set; }
